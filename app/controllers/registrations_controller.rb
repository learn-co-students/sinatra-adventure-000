class RegistrationsController < ApplicationController
  ...
  get '/new' do
    # raise Unauthorized unless user_registered?
    if !user_registered?
      "User Not Registered"
    else
    # keep this line of code in place to protect this sacred page from interlopers who have not properly completed
    # the maze you are constructing. You will need to implement the code to allow them to pass this challenge when
    # they have registered
      @email = session[:email]
      erb :'/new_user'

    # You will need to send properly registered people to me and render a template that will tell them they
